<template>
  <div
    class="chart_wrap"
    :style="'border-radius:' + radius + ';overflow:hidden;background:' + backgroundColor + ';'"
  >
          ...
          chart.getZr().on('click', params => {
            ...
            if (chart.containPixel('grid', pointInPixel)) {
              ...
              if (type === 'bar' || type === 'line' || type === 'mix') {
                ...
                let yIndex = chart.convertFromPixel({ seriesIndex: 0 }, [
                  params.offsetX,
                  params.offsetY,
                ])[1]
